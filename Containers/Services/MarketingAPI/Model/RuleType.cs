using EnjoyCodes.eShopOnContainers.Services.MarketingAPI.Infrastructure.Exceptions;
using System;
using System.Collections.Generic;
using System.Linq;

namespace EnjoyCodes.eShopOnContainers.Services.MarketingAPI.Model
{
    public sealed class RuleType
    {
        ...
        public static IEnumerable<RuleType> List() => new[] { UserProfileRule, PurchaseHistoryRule, UserLocationRule };
