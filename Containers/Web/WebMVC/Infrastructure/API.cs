namespace EnjoyCodes.eShopOnContainers.WebMVC.Infrastructure
{
    public static class API
    {
        public static class Purchase
        {
            public static string AddItemToBasket(string baseUri) => baseUri;
            public static string UpdateBasketItem(string baseUri) => baseUri;

            public static string GetOrderDraft(string baseUri, string basketId) => $"{baseUri}/draft/{basketId}";
        }
