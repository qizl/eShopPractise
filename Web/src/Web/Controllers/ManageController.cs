...
using EnjoyCodes.eShopOnWeb.Web.Extensions;
using EnjoyCodes.eShopOnWeb.Web.ViewModels.Manage;
...
namespace Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (user == null)
                throw new ApplicationException($"Unable to load user with ID '{this._userManager.GetUserId(User)}'.");
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey) => string.Format(AuthenicatorUriFormat, _urlEncoder.Encode("eShopOnWeb"), _urlEncoder.Encode(email), unformattedKey);
    }
}